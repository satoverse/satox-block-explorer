          ...
          <div className="flex items-center space-x-4">
            ...
            <form onSubmit={handleSearch} className="hidden md:block">
              <input
                ...
                className="rounded-md border border-gray-300 dark:border-gray-700 px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-64 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:bg-gray-800 dark:placeholder-gray-400 bg-white"
              />
            </form>
            {/* Connection Status */}
